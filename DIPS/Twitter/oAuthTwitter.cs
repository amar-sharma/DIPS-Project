...
namespace DIPS.Twitter
{
    public class oAuthTwitter : OAuthBase
    {
        ...
        //this property should not have a dependency on the Settings file.
        ...
        //added for convenience. Reset the state of the oAuthTwitter object.
        public void Reset()
        {
            OAuthToken = Token = TokenSecret = PIN = String.Empty;
        }
    }
}
